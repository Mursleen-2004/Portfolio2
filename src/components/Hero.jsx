      ...
      <motion.div className="w-full md:w-1/2 space-y-5 text-center md:text-left z-10"
        ...
        <motion.div variants={item} className="flex justify-center md:justify-start">
          <span className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-medium border ${
            isDark ? "bg-emerald-900/20 border-emerald-500/30 text-emerald-400" : "bg-emerald-50 border-emerald-400/50 text-emerald-600"}`}>
        ...
        <motion.div variants={item} className="flex flex-wrap justify-center md:justify-start gap-3 pt-1">
          ...
          <a href="/Resume.pdf" download
            className={`px-6 py-2.5 rounded-xl text-sm font-semibold transition-all duration-300 hover:scale-105 border ${
              isDark ? "border-[#22D3EE]/40 text-[#22D3EE] hover:bg-[#22D3EE]/10" : "border-sky-400/50 text-sky-600 hover:bg-sky-50"}`}>
            Download CV
          </a>
          <a href="/contact"
            className={`px-6 py-2.5 rounded-xl text-sm font-semibold transition-all duration-300 hover:scale-105 border ${
              isDark ? "border-white/15 text-slate-300 hover:border-white/30 hover:bg-white/5" : "border-slate-300 text-slate-600 hover:bg-slate-50"}`}>
            Hire Me
          </a>
        </motion.div>
      </motion.div>
